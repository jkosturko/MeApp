//
//  PictureCategories_TableViewController.m
//  JessicaKosturko2
//
...
@implementation PictureCategories_TableViewController{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [imageCategories objectAtIndex:indexPath.row];
